...
void InterpolationHelper::set_both_rates(const float p_new_value) {
...
void InterpolationHelper::global_rate_changed(const float p_new_value) {
	if (!should_interpolate) {
		interpolation_rate = p_new_value;
	}
}

void InterpolationHelper::maybe_reset_rate(const float p_global_rate) {
	if (should_interpolate) {
...
void InterpolationHelper::set_should_interpolate(const bool p_should_interpolate) {
...
void InterpolationHelper::set_damping(const float p_damping) {
	damping = p_damping;
}

float InterpolationHelper::get_damping() const {
	return damping;
}
...
void InterpolationHelper::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_damping", "damping"), &InterpolationHelper::set_damping);
	ClassDB::bind_method(D_METHOD("get_damping"), &InterpolationHelper::get_damping);
